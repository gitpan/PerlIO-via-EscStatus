...
An C<EscStatus::Parser> object parses out status strings from text.  This is
used by EscStatus and is offered for use parsing a stream the same way
EscStatus does.
